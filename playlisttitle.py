...
"""
Playlist pytube plugin for get all titles fast v1
Resume ###
lines used
35 - declared array memory
46 - add url page to array 100 links
90 - add all pages if found

funcitons
282 -_pagaesavearr - get page and transfer for variable
285 playlist_titles - call video_urls for get links pages, get array pages, filter and return array

"""

class PlaylistGet(Sequence):
    ...
    """Patch title ----------------------------------------------------------------------------------//
    """
    def _pagaesavearr(self, pg):
            self.pagesaved.append(pg)
